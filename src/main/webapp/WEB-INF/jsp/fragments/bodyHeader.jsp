...
<nav class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    <div class="container">
        <div class="dropdown show">
            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="mainMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <spring:message code="app.menu"/>
            </a>

            <div class="dropdown-menu" aria-labelledby="mainMenu">
                <a class="dropdown-item" href="./uploading"><spring:message code="app.uploading"/></a>
                <a class="dropdown-item" href="./packs"><spring:message code="app.packs"/></a>
                <a class="dropdown-item" href="./reports"><spring:message code="app.reports"/></a>
            </div>
        </div>


<%--        <a href="meals" class="navbar-brand"><img src="resources/images/logo.svg"> <spring:message code="app.title"/></a>--%>
